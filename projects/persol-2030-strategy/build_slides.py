...
FB_ITEMS = [
    ...
    (WARN, "2", "この課題設定は、適当か",
     "「登録者数を伸ばす」「登録者を就職に転換する」の2つで課題を捉えています。"),
]
...
s = slide_new("本日いただきたいフィードバック", kicker="GOAL",
              note="定義の詳細は P.7〜9、課題の詳細は P.18 でご説明します。")
fb_body(s)
...
s = slide_new("差分の要因 ── 足りないのは「就職者数」",
              kicker="② 差分の要因 ─ 構造",
              note="「登録者数を伸ばす」「登録者を就職に転換する」それぞれの課題は、"
                   "③課題（P.18）でご説明します。")
...
# ================================================================ スライド 18
s = slide_new("いま挙がっている課題 ── まだ発散段階です",
              kicker="③ 課題（発散）",
...
steps = [
    ("STEP 1", "本日 〜 次回の中間FBまで",
     ["現場社員の方へのヒアリングと、メンターからのフィードバックをもとに議論する",
      "P.18 の課題を検証し、捉え方を詰めたうえで、解決策の方向性を導き出す",
